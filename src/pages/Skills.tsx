              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {category.skills.map((skill, idx) => (
                    <span
                      key={idx}
                      className="px-3 py-1.5 glass-pill rounded-lg text-sm font-medium text-glassFg transition-all duration-200 hover:brightness-95 hover:scale-110 hover:-translate-y-0.5 hover:text-accent-hover hover:shadow-[0_0_14px_rgba(59,130,246,0.35)] cursor-default"
                    >
                      {skill}
                    </span>
                  ))}
        ...
        <div className="mt-12 glass-card rounded-2xl p-8">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              <span
                key={index}
                className="px-4 py-2 glass-pill rounded-full text-sm font-medium text-glassFg transition-all duration-300 hover:bg-accent2 hover:text-accent-foreground hover:scale-110 hover:shadow-[0_0_14px_rgba(59,130,246,0.45)] cursor-default"
              >
                {tool}
              </span>
            ))}
